...
function checkAnswers(){
    ...
    var submitString = 'http://tekstur.dk/kn/datasjek/submititem.php?uid=' + uid + '&itemid=' + $XML.find("kntest").find('opgave').eq(currentQuestionIndex).attr("id") +'&answer='+ selectedAnswer +'&correct='+ answerScore +'&time='+ questionTime +'&totaltime='+ (new Date().getTime()-questionsStartTime) +'&nocache=' + Math.random();
