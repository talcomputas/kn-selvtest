...
const nbSamleSjekken: Consultation = nbsamltetestenRaw as Consultation;
...
const nblesetesten: Consultation = nblesetestenRaw as Consultation;
...
const nnleseskrivesjekken: Consultation = nbsamltetestenRaw as Consultation;
