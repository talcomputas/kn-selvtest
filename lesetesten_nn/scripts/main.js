...
function startTestIntro() {
  ...
  $("#intro-content").html(
    "<span class='intro-sign'><p>Trykk på lydikonet dersom du ønskjer å få denne teksten opplesen.</p></span><span 	class='intro-text'><p>I denne testen skal du lese nokre korte tekstar utan å bruke hjelpemiddel. Klikk på det ordet du meiner passar best i teksten. Du kan endre valet ditt ved å trykkje på eit av dei andre orda. Eitt av alternativa er rett.</p></span><div class='task intro'><h2>Kneskade</h2><p>Anders har skada kneet i ei skiulukke. Han skal opererast om ei veke. Etter operasjonen skal<span class='options'><span>underarmen</span><span class='selected'>kneet</span><span>hjernen</span><span>føtene</span></span>&nbsp;trenast opp. Fysioterapeuten hans meiner at han må bruke<span class='options'><span>stylter</span><span class='selected'>krykkjer</span><span>skøyter</span><span>rulleski</span></span>&nbsp;i om lag 3 månader.</p></div><span class='intro-text'><p>Her er det fire alternativ i kvar setning, og orda <i>kneet</i> og <i>krykkjer</i> er valde fordi dei passar best.</p></span><span class='intro-sign'><p>Trykk på lydikonet dersom du ønskjer å få denne teksten opplesen.</p></span>"
  );
...
function introNextComplete() {
  ...
  $("#intro-proceed-next").hide();
  $("#intro-content").html(
    "<div class='task intro'><h2>Sofies hofte</h2><p>Sofie har gikt i den høgre hofta. <span class='options'><span>Dei</span><span class='selected'>Ho</span><span>Han</span><span>Enkelte</span></span>&nbsp;skal opererast om ei veke. Etter operasjonen skal<span class='options'><span>underarmen</span><span class='selected'>hofta</span><span>hjernen</span><span>føtene</span></span>&nbsp;trenast opp.</p></div><span class='intro-text'><p>Det står fire ord i ramma i første setning, og ordet 'Ho' er markert. I den siste setninga er 'hofta' markert. Desse orda er valde fordi dei passar best.</p><p>Då står det:</p><p>Sofie har gikt i den høgre hofta. Ho skal opererast om ei veke. Etter operasjonen skal funksjonen i hofta trenast opp.</p><p>Klikk på lydikonet dersom du vil høyre instruksjonane ein gong til. Klikk på pila i høgre hjørnet merkt 'neste' dersom du vil gå vidare. Når du no trykkjer på pila merkt 'neste', kjem du til oppgåvene du skal lese sjølv.</p></span>"
  );
...
function setupResult() {
  ...
  questback.popup.create("https://response.questback.com/vox/3eorvv8nvw", {
  ...
  if (finalScore >= 4) {
    //grøn
    $(".feedback.reading h2").html("Resultatet ditt er over 4.");
    $(".feedback.reading p").html(
      "Resultat over 4 viser at du er ein god lesar. Du les vanlege tekstar både raskt og nøyaktig."
    );
    ...
    //GUL
    $(".feedback.reading h2").html("Resultatet ditt er mellom 3 og 4.");
    $(".feedback.reading p").html(
      "Dette resultatet tyder på at lesedugleiken din er nokså bra, men at nokre tekstar kan vere vanskelege og ta tid for deg å lese."
    );
    ...
    //RØD
    $(".feedback.reading h2").html("Resultatet ditt er 0–3.");
    $(".feedback.reading p").html(
      "Dette resultatet tyder på mange tekstar kan vere vanskelege og ta lang tid for deg å lese. Du kan ha nytte av å øve meir på å lese."
    );
